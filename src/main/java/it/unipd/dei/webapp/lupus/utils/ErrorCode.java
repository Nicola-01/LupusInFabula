...
//    NO_HOMEWORKS_TO_PUBLISH(-101, HttpServletResponse.SC_NOT_FOUND, "No homeworks to publish."),
    ...
    ROLE_NOT_EXIST(-109, HttpServletResponse.SC_BAD_REQUEST, "One or more roles does not exist"),
    NUMBER_PLAYERS_ROLES_NOT_MATCH(-110, HttpServletResponse.SC_BAD_REQUEST, "Number of players entered does not correspond to the number of roles"),
    NOT_ENOUGH_PLAYERS(-111, HttpServletResponse.SC_BAD_REQUEST, "Not enough players"),
    INVALID_GAMESETTINGS(-112, HttpServletResponse.SC_BAD_REQUEST, "The parameter does not exist"),
    INVALID_ROLES_CARDINALITY(-113, HttpServletResponse.SC_BAD_REQUEST, "Invalid role max cardinality"),
