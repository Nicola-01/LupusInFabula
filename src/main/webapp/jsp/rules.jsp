...
<div class="container">
    ...
    <ol>
        <li>
            ...
            <p>In the remote village of Fabula, some people become werewolves at night. They attack an innocent person to
                satisfy their instincts. During the day, the survivors discuss what to do. At the end of the discussion, they
                lynch one of them. Who will survive the massacre?</p>
        </li>
    </ol>
<%--    <p class="rules">--%>
    ...
    <ol style="--length: 7" role="list">
        <li id="aim" style="--i: 1">
            ...
            <p>There are two factions in the game: the Werewolves and the Villagers. The aim of the Werewolf faction is
                to eliminate all villagers. Conversely, the aim of the Villagers faction is to lynch all the Werewolves.</p>
        </li>
        <li id="preparation" style="--i: 2">
            <h3><strong>Preparation</strong></h3>
            <p>Before the game starts, one player is chosen to be the master/moderator. He doesn’t belong to any faction,
                and he will only manage the game tracking everything that will happen. The other players will play the role
                given to them by their card and look at their own card secretly.</p>
        </li>
        <li id="game" style="--i: 3">
            <h3><strong>Game</strong></h3>
            <p>The game is divided into two phases: night and day. At night each role with an effect that resolves during
                ...
                people will discuss and vote to lynch someone, hopefully a wolf or a member of the wolf faction.</p>
        </li>
        <li id="night" style="--i: 4">
            ...
            <p>The moderator declares the beginning of the night (”it is night, everyone close your eyes”). All players
                ...
                then begins to call each role with effect:<br>
        ...
        <li id="victory" style="--i: 7">
            ...
            <p>The master declares the game over with a villagers victory if the villagers lynch all the werewolves.
                ...
                used
                - like medium, knight, werehamster etc - in order to make the game more entertaining, with specific rules
                applying
                to each character.</p>
        </li>
    </ol>
                    ...
                    <div class="mySlides slide">
                        <div class="row">
                            ...
                            <div class="row col-md-7 p-4 d-flex justify-content-center">
                                <div class="row col p-4 d-flex justify-content-center">
                                    <c:out value="${fn:toUpperCase(role.name)}"/>
                                </div>
                                <p class="description">
                                    <c:out value="${role.description}"/></p>
                                <div class="row col">
                                    <div class="col wins">
