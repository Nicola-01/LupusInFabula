...
<div>
    ...
    <p class="rules">
        The master declares the game over with a villagers victory if the villagers lynch all the werewolves.
        Werewolves,
                    ...
                    <div class="mySlides slide">
                        <div class="row">
                            ...
                            <div class="row col-md-7 p-4 d-flex justify-content-center">
                                <p style="padding:3%; display: flex; justify-content: center; align-items: center">
