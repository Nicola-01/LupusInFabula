...
VALUES ('esempio', 1, 'master', null, null, null), -- esempio is the master
       ('user1', 1, 'explorer', null, null, null),
...
VALUES (1, 'player0', 1, 0, 0, 'test', 'player3'),
       (1, 'player2', 3, 1, 1, 'test', 'player3'),
       (1, 'player3', 4, 0, 0, 'test', 'player3'),
       (1, 'player4', 3, 1, 1, 'test', 'player3'),
       (1, 'player3', 1, 0, 0, 'test', 'player3'),
       (1, 'player5', 5, 1, 1, 'test', 'player3'),
       (1, 'player6', 6, 0, 0, 'test', 'player3'),
       (1, 'player7', 7, 1, 2, 'test', 'player3');
