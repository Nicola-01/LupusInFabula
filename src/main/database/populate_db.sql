...
INSERT INTO Role (name, type, with_who_wins, max_number, description) VALUES
                    ...
                    ('puppy', 1, 1, 3, 'The youngest member of the wolf pack usually joins in the wolf chat. However, due to his mischievous behaviour, the seer sees him as a Non-Wolf and he can be nominated for defrocking. If he is the last wolf remaining in the game, he cannot be mauled on the first night he is alone.'),
